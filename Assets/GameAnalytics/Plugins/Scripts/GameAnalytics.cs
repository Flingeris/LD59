...
#pragma warning disable 0618
    ...
    public partial class GameAnalytics : MonoBehaviour
    {
        ...
        {
            get { return _hasInitializeBeenCalled; }
        }
...
# endif
        ...
        private static void InitAPI()
        {
            try
            {
                _settings = (GameAnalyticsSDK.Setup.Settings)Resources.Load("GameAnalytics/Settings",
                    typeof(GameAnalyticsSDK.Setup.Settings));
        ...
        private static void InternalInitialize()
        {
            ...
            if (platformIndex >= 0)
            {
                if (GameAnalytics.SettingsGA.UsePlayerSettingsBuildNumber)
                {
                    ...
                    if (GameAnalytics.SettingsGA.Platforms[platformIndex] == RuntimePlatform.Android ||
                        GameAnalytics.SettingsGA.Platforms[platformIndex] == RuntimePlatform.IPhonePlayer)
                    {
